...
namespace MotoPartesErazo.Vistas
{
    public partial class fArticulos : Form
    {
        ...
        {
            dataGrid_Articulos.Rows.Add(2, 2365,"Patillas de frenos",3,"Honda biz","china",125.23,"Pastilla de frenos para biz y gerero","Todo respuesto","bicicleteria");
            dataGrid_Articulos.Rows.Add(23, 2365, "Aceite motul 5100",2, "Honda biz", "china", 125.23, "Pastilla de frenos para biz y gerero","Todo respuesto Motos", "Motos");
            dataGrid_Articulos.Rows.Add(22, 2365, "Cubierta 125x25x332",5, "Honda biz", "china", 125.23, "Pastilla de frenos para biz y gerero","Moto Partes", "rodamientos");
            dataGrid_Articulos.Rows.Add(5, 2455, "Platicos twiter", 10, "Honda biz", "china", 125.23, "Pastilla de frenos para biz y gerero","Todo respuesto Motos", "Motos");
